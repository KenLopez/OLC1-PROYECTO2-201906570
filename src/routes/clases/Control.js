        ...
        switch (this.type) {
            case Type.BREAK:
                if(String(ambito).includes(Type.FOR)||String(ambito).includes(Type.WHILE)||String(ambito).includes(Type.DOWHILE)||String(ambito).includes(Type.SWITCH)){
                    ...
                    global.newError(Type.SEMANTICO, 'No se pudo realizar la instruccion: '+Type.BREAK+', no se encuentra en ámbito permitido.',this.fila, this.columna)
                    return Type.ERROR
                }
            case Type.CONTINUE:
                if(String(ambito).includes(Type.FOR)||String(ambito).includes(Type.WHILE)||String(ambito).includes(Type.DOWHILE)){
                    ...
                    global.newError(Type.SEMANTICO, 'No se pudo realizar la instruccion: '+Type.CONTINUE+', no se encuentra en ámbito permitido.',this.fila, this.columna)
                    return Type.ERROR
                }
        }
