        ...
        switch (this.type) {
            case Type.BREAK:
                if(String(ambito).includes(Type.FOR)||String(ambito).includes(Type.WHILE)||String(ambito).includes(Type.DOWHILE)||String(ambito).includes(Type.SWITCH)){
                    ...
                    this.newError(Type.SEMANTICO, 'No se pudo realizar la instruccion: '+Type.BREAK+', no se encuentra en ámbito permitido.',instruccion.fila, instruccion.columna)
                    return Type.ERROR
                }
            case Type.CONTINUE:
                if(String(ambito).includes(Type.FOR)||String(ambito).includes(Type.WHILE)||String(ambito).includes(Type.DOWHILE)){
                    ...
                    this.newError(Type.SEMANTICO, 'No se pudo realizar la instruccion: '+Type.CONTINUE+', no se encuentra en ámbito permitido.',instruccion.fila, instruccion.columna)
                    return Type.ERROR
                }
        }
